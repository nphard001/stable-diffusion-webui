                        ...
                        with FormRow():
                            ...
                            if opts.dimensions_and_batch_together:
                                with gr.Column(elem_id="txt2img_column_batch"):
                                    ...
                                    batch_size = gr.Slider(minimum=1, maximum=64, step=1, label='Batch size', value=1, elem_id="txt2img_batch_size")
                        ...
                        with FormRow():
                            ...
                            if opts.dimensions_and_batch_together:
                                with gr.Column(elem_id="img2img_column_batch"):
                                    ...
                                    batch_size = gr.Slider(minimum=1, maximum=64, step=1, label='Batch size', value=1, elem_id="img2img_batch_size")
        ...
        with gr.Row(variant="compact", equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Train", id="train"):
                    ...
                    with FormRow():
                        embedding_learn_rate = gr.Textbox(label='Embedding Learning rate', placeholder="Embedding Learning rate", value="5e-3", elem_id="train_embedding_learn_rate")
